class Boringssl < Formula
  ...
  url "https://boringssl.googlesource.com/boringssl.git", :revision => "3a9e1fba0e3bcf014caa2df143a70475068447dc"
  version "0.0.0.28" # Fake version so we can update the formula regularly & easily.
