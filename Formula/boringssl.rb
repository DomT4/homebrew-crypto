class Boringssl < Formula
  ...
  url "https://boringssl.googlesource.com/boringssl.git", :revision => "c8e664b70a6faaa5ee1d49f4ae41efe2ed3be5ad"
  version "0.0.0.39" # Fake version so we can update the formula regularly & easily.
