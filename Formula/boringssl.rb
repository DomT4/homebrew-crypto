class Boringssl < Formula
  ...
  url "https://boringssl.googlesource.com/boringssl.git", :revision => "4365c3f522f2fc57fa0c87bde5f25ea98dd9a59c"
  version "0.0.0.51" # Fake version so we can update the formula regularly & easily.
