class Boringssl < Formula
  ...
  url "https://boringssl.googlesource.com/boringssl.git", :revision => "894a47df2423f0d2b6be57e6d90f2bea88213382"
  version "0.0.0.48" # Fake version so we can update the formula regularly & easily.
