class Boringssl < Formula
  ...
  url "https://boringssl.googlesource.com/boringssl.git", :revision => "fb8e67889792e2a5914bcfdc590c250141645a74"
  version "0.0.0.49" # Fake version so we can update the formula regularly & easily.
