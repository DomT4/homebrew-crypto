class Boringssl < Formula
  ...
  url "https://boringssl.googlesource.com/boringssl.git", :revision => "bc97c69d76d93db3e6d811ff85c6dfde0c6430aa"
  version "0.0.0.32" # Fake version so we can update the formula regularly & easily.
