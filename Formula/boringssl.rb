class Boringssl < Formula
  ...
  url "https://boringssl.googlesource.com/boringssl.git", :revision => "4616bb1e6e0387de15eabb95575974d3ba467307"
  version "0.0.0.17" # Fake version so we can update the formula regularly & easily.
