class Boringssl < Formula
  ...
  url "https://boringssl.googlesource.com/boringssl.git", :revision => "afd565ff9cb4fe1d20f4aa2ee7339c86998aafae"
  version "0.0.0.45" # Fake version so we can update the formula regularly & easily.
