class Boringssl < Formula
  ...
  url "https://boringssl.googlesource.com/boringssl.git", :revision => "32f16506586ab776f29235159e2536f39c8ef1d9"
  version "0.0.0.7" # Fake version so we can update the formula regularly & easily.
