class Boringssl < Formula
  ...
  url "https://boringssl.googlesource.com/boringssl.git", :revision => "3a39b06011d31357c98091687e24ab38a3e8514e"
  version "0.0.0.47" # Fake version so we can update the formula regularly & easily.
