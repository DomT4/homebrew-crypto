class Boringssl < Formula
  ...
  url "https://boringssl.googlesource.com/boringssl.git", :revision => "e72df93461c6d9d2b5698f10e16d3ab82f5adde3"
  version "0.0.0.52" # Fake version so we can update the formula regularly & easily.
