class Boringssl < Formula
  ...
  url "https://boringssl.googlesource.com/boringssl.git", :revision => "82aa28fa81222a4a614ccf43fbc5b6e9bf02b588"
  version "0.0.0.40" # Fake version so we can update the formula regularly & easily.
