class Boringssl < Formula
  ...
  url "https://boringssl.googlesource.com/boringssl.git", :revision => "685402fadd8e90f1cd70ded7f7590600128d7d89"
  version "0.0.0.35" # Fake version so we can update the formula regularly & easily.
