class Boringssl < Formula
  ...
  url "https://boringssl.googlesource.com/boringssl.git", :revision => "e7806fd47771476facb71e0a3cc045f4756229a5"
  version "0.0.0.43" # Fake version so we can update the formula regularly & easily.
