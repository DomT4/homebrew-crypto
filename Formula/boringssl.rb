class Boringssl < Formula
  ...
  url "https://boringssl.googlesource.com/boringssl.git", :revision => "4a59709ca12b744cf3778e7cabf5ae3cc571e827"
  version "0.0.0.31" # Fake version so we can update the formula regularly & easily.
