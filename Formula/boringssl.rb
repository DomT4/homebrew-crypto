class Boringssl < Formula
  ...
  url "https://boringssl.googlesource.com/boringssl.git", :revision => "dcb3383463fa2c70bbafefff53004f6896dbc504"
  version "0.0.0.50" # Fake version so we can update the formula regularly & easily.
