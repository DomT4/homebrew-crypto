class Boringssl < Formula
  ...
  url "https://boringssl.googlesource.com/boringssl.git", :revision => "3202750a98fbfa3b72ca1bc02f59ac1f36948589"
  version "0.0.0.46" # Fake version so we can update the formula regularly & easily.
