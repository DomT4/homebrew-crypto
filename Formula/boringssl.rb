class Boringssl < Formula
  ...
  url "https://boringssl.googlesource.com/boringssl.git", :revision => "a83cc803b118d5ac675e021bc219397560423764"
  version "0.0.0.2" # Fake version so we can update the formula regularly & easily.
