class Boringssl < Formula
  ...
  url "https://boringssl.googlesource.com/boringssl.git", :revision => "83f182c6c5f6d1318329c2fe645f74d832e83701"
  version "0.0.0.21" # Fake version so we can update the formula regularly & easily.
