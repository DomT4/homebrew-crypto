class Boringssl < Formula
  ...
  url "https://boringssl.googlesource.com/boringssl.git", :revision => "ce514698f56b2cdb37cfe42de1a2e8010cd15186"
  version "0.0.0.42" # Fake version so we can update the formula regularly & easily.
