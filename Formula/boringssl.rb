class Boringssl < Formula
  ...
  url "https://boringssl.googlesource.com/boringssl.git", :revision => "c5eb4676b69d6431cce4904ddc3703f3358a2fd9"
  version "0.0.0.44" # Fake version so we can update the formula regularly & easily.
