class Boringssl < Formula
  ...
  url "https://boringssl.googlesource.com/boringssl.git", :revision => "a307dfd29fccb830b1c59b25060ded9a11254db4"
  version "0.0.0.3" # Fake version so we can update the formula regularly & easily.
