class Boringssl < Formula
  ...
  url "https://boringssl.googlesource.com/boringssl.git", :revision => "bd15a8e74894616ca8ad04fc2942b958f99000a1"
  version "0.0.0.27" # Fake version so we can update the formula regularly & easily.
