class Boringssl < Formula
  ...
  url "https://boringssl.googlesource.com/boringssl.git", :revision => "978f16ea08a24cb740741c9956a934544c767db3"
  version "0.0.0.41" # Fake version so we can update the formula regularly & easily.
